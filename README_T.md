...
|主控|英博尔驱动模块|0x305|8||dirving mode and gear|motor_speed>>8(uint16_t)|motor_speed(uint16_t)|driving_acc(uint8_t)|dirving_dec(uint8_t)|0|0|data_checksums|byte0[0:2]:mode<br>(0-manu_mode,<br>1-auto_mode) byte0[3:5]:gear<br>0-P_Gear,<br>1-N_Gear,<br>2-D_gear,<br>3-R_Gear|
